...
- Update SwiftSpice to 0.4.1 to recover held keyboard modifiers from key-down
  flags when modifier-change notifications are missing, preserving intended
  punctuation after focus changes.

### Development

- Support local testing with an editable SwiftSpice checkout while requiring
  the pinned release for distributable ZIP packaging.
...
- Restored compatibility with SwiftPM's default Swift Build by consuming
  SwiftSpice's isolated static-framework XCFrameworks instead of overlapping
  binary-target header and module-map outputs.
- Accepted both flat and standard macOS layouts for the SwiftSpice Metal
  compositor resource bundle during application assembly.

### Changed

- Updated SwiftSpice to 0.1.8 and removed the legacy native build-system
  override from the release build path.
...
[Unreleased]: https://github.com/BeriBeli/spice-mac/compare/v0.5.5...HEAD
[0.5.5]: https://github.com/BeriBeli/spice-mac/compare/v0.5.4...v0.5.5
[0.5.4]: https://github.com/BeriBeli/spice-mac/compare/v0.5.3...v0.5.4
[0.5.3]: https://github.com/BeriBeli/spice-mac/compare/v0.5.2...v0.5.3
[0.5.2]: https://github.com/BeriBeli/spice-mac/compare/v0.5.1...v0.5.2
[0.5.1]: https://github.com/BeriBeli/spice-mac/compare/v0.5.0...v0.5.1
